...
- [x] Enable the Obsidian **Bases** core plugin. ✅ 2026-06-18
- [x] Confirm TaskNotes has created the default `.base` files in `TaskNotes/Views/`. ✅ 2026-06-18
- [x] Open the command palette and run **TaskNotes: Open tasks view**. ✅ 2026-06-18
...
- [x] Create a TaskNotes inbox task due tomorrow #admin ✅ 2026-06-18
- [x] Schedule a 20 minute planning task for next Monday #planning ✅ 2026-06-18
